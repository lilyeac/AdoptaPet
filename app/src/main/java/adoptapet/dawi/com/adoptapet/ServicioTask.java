...
public class ServicioTask extends AsyncTask<Void, Void, String> {
    ...
    public String razaMas="";
    public String edadMas="";
    public String desMas="";
    public String sexoMas="";
    //constructor del hilo (Asynctask)
    public ServicioTask(Context ctx, String linkAPI, String nomMas, String  razaMas, String edadMas,String desMas,String sexoMas ){
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            parametrosPost.put("nomMas",nomMas);
            parametrosPost.put("razaMas",razaMas);
            parametrosPost.put("edadMas",edadMas);
            parametrosPost.put("desMas",desMas);
            parametrosPost.put("sexoMas",sexoMas);
